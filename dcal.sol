/*
   DCAL - Digital Currency Analysis Launchpad
   One simple contract - No reflection, so we don't feed the whales!
     2% fee to developers for creating the most amazing analytic platform to ever exist
     3% for liquidity
   DCAL developer success is directly proportional to DCAL currency success. No rug pull, no questions, no FUD!
*/
...
contract DCAL is ERC20, Ownable {
    ...
    ) public ERC20("Digital Currency Analysis Launchpad", "DCAL") {
